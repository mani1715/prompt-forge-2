...
### Chrome/Edge:
1. Open the page: `https://webdev-build.preview.emergentagent.com`
...
1. Open the admin panel: `https://webdev-build.preview.emergentagent.com/admin/login`
...
fetch('https://webdev-build.preview.emergentagent.com/api/')
  .then(r => r.json())
...
fetch(`https://webdev-build.preview.emergentagent.com/api/admin/client-projects/${PROJECT_ID}/tasks`, {
  method: 'POST',
  headers: {
...
4. Reopen browser
5. Go to: `https://webdev-build.preview.emergentagent.com/admin/login`
6. Try again
...
2. Go to: `https://webdev-build.preview.emergentagent.com/admin/login`
3. Login
4. Try adding a task
...
Should include: `https://webdev-build.preview.emergentagent.com`
