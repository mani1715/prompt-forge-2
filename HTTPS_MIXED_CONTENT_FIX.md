...
### Error Message
```
Mixed Content: The page at 'https://webdev-build.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://webdev-build.preview.emergentagent.com`): Uses `/api` → converted to `https://webdev-build.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://webdev-build.preview.emergentagent.com,https://webdev-build.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://webdev-build.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://webdev-build.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://webdev-build.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://webdev-build.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://webdev-build.preview.emergentagent.com`
