...
### Error Message
```
Mixed Content: The page at 'https://code-craft-57.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://code-craft-57.preview.emergentagent.com`): Uses `/api` → converted to `https://code-craft-57.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://code-craft-57.preview.emergentagent.com,https://code-craft-57.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://code-craft-57.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://code-craft-57.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://code-craft-57.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://code-craft-57.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://code-craft-57.preview.emergentagent.com`
