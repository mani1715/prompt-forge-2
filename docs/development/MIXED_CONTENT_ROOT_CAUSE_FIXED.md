...
# CORS Configuration  
CORS_ORIGINS=https://prompt-forge-116.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://prompt-forge-116.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://prompt-forge-116.preview.emergentagent.com/api/client/projects`
...
When you access: `https://prompt-forge-116.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://prompt-forge-116.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://prompt-forge-116.preview.emergentagent.com` (production)
