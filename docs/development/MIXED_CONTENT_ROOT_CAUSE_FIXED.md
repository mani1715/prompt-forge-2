...
# CORS Configuration  
CORS_ORIGINS=https://code-forge-43.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://code-forge-43.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://code-forge-43.preview.emergentagent.com/api/client/projects`
...
When you access: `https://code-forge-43.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://code-forge-43.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://code-forge-43.preview.emergentagent.com` (production)
