...
# CORS Configuration  
CORS_ORIGINS=https://web-codebase-3.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://web-codebase-3.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://web-codebase-3.preview.emergentagent.com/api/client/projects`
...
When you access: `https://web-codebase-3.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://web-codebase-3.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://web-codebase-3.preview.emergentagent.com` (production)
