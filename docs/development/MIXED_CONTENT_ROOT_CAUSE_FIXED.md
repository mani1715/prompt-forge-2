...
# CORS Configuration  
CORS_ORIGINS=https://bug-solver-14.preview.emergentagent.com,http://localhost:3000
...
1. **User loads page**: `https://bug-solver-14.preview.emergentagent.com/client/dashboard`
...
2. **Frontend makes API call**: 
   ...
   - Request: `https://bug-solver-14.preview.emergentagent.com/api/client/projects`
...
When you access: `https://bug-solver-14.preview.emergentagent.com/client/dashboard`
...
**Check Network Tab**:
- Request URL should be: `https://bug-solver-14.preview.emergentagent.com/api/client/projects`
- Status: `200 OK`
- Protocol: `https`
...
Currently allows:
- `https://bug-solver-14.preview.emergentagent.com` (production)
