...
1. Navigate to: `https://web-codebase-3.preview.emergentagent.com/client/login`
...
3. **Check Network Tab** (F12 → Network tab)
   - All requests should be to `https://web-codebase-3.preview.emergentagent.com/api/...`
   - ❌ No requests should use `http://` protocol

#### C. Verify Data Syncing
1. Keep client dashboard open
2. In another tab, open admin panel: `https://web-codebase-3.preview.emergentagent.com/admin/login`
...
#### A. Login
1. Navigate to: `https://web-codebase-3.preview.emergentagent.com/admin/login`
2. Login with:
   - Username: `admin`
   - Password: `admin123`
...
#### A. Home Page
1. Navigate to: `https://web-codebase-3.preview.emergentagent.com/`
...
```
[API Config] Base URL constructed: https://web-codebase-3.preview.emergentagent.com/api
[API Request] GET /client/projects Base: https://web-codebase-3.preview.emergentagent.com/api
[API Request] POST /admin/clients Base: https://web-codebase-3.preview.emergentagent.com/api
```
...
### Admin Login
- URL: `https://web-codebase-3.preview.emergentagent.com/admin/login`
- Username: `admin`
- Password: `admin123`
- ⚠️ **IMPORTANT**: Change this password after testing!

### Client Login
- URL: `https://web-codebase-3.preview.emergentagent.com/client/login`
