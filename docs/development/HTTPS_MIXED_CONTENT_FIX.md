...
### Error Message
```
Mixed Content: The page at 'https://prompt-forge-116.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://prompt-forge-116.preview.emergentagent.com`): Uses `/api` → converted to `https://prompt-forge-116.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://prompt-forge-116.preview.emergentagent.com,https://prompt-forge-116.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://prompt-forge-116.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://prompt-forge-116.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://prompt-forge-116.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://prompt-forge-116.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://prompt-forge-116.preview.emergentagent.com`
