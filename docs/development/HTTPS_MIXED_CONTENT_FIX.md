...
### Error Message
```
Mixed Content: The page at 'https://bug-solver-14.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://bug-solver-14.preview.emergentagent.com`): Uses `/api` → converted to `https://bug-solver-14.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://bug-solver-14.preview.emergentagent.com,https://bug-solver-14.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://bug-solver-14.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://bug-solver-14.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://bug-solver-14.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://bug-solver-14.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://bug-solver-14.preview.emergentagent.com`
