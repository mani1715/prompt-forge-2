...
### Error Message
```
Mixed Content: The page at 'https://portfolio-draft-3.preview.emergentagent.com/admin/client-projects' 
...
- **Production HTTPS** (`https://portfolio-draft-3.preview.emergentagent.com`): Uses `/api` → converted to `https://portfolio-draft-3.preview.emergentagent.com/api`
...
```env
CORS_ORIGINS=http://localhost:3000,https://portfolio-draft-3.preview.emergentagent.com,https://portfolio-draft-3.preview.emergentagent.com
```
...
### 1. Admin Login
- Go to: `https://portfolio-draft-3.preview.emergentagent.com/admin/login`
...
[API Config] Current origin: https://portfolio-draft-3.preview.emergentagent.com
[API Config] Current protocol: https:
[API Config] ✅ Using absolute HTTPS URL: https://portfolio-draft-3.preview.emergentagent.com/api
```
...
### Check Backend CORS
```bash
curl -I http://localhost:8001/api/ -H "Origin: https://portfolio-draft-3.preview.emergentagent.com"
```

Should include: `Access-Control-Allow-Origin: https://portfolio-draft-3.preview.emergentagent.com`
