...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://bug-solver-14.preview.emergentagent.com/api"
...
// Returns: "https://bug-solver-14.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://bug-solver-14.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://bug-solver-14.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://bug-solver-14.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://bug-solver-14.preview.emergentagent.com/api
[API Request] GET https://bug-solver-14.preview.emergentagent.com/api/client/projects
```
...
- Go to: `https://bug-solver-14.preview.emergentagent.com/client/dashboard`
- Login if needed
