...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://prompt-forge-116.preview.emergentagent.com/api"
...
// Returns: "https://prompt-forge-116.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://prompt-forge-116.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://prompt-forge-116.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://prompt-forge-116.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://prompt-forge-116.preview.emergentagent.com/api
[API Request] GET https://prompt-forge-116.preview.emergentagent.com/api/client/projects
```
