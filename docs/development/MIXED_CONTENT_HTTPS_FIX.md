...
- **Page URL**: `https://portfolio-draft-3.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://portfolio-draft-3.preview.emergentagent.com`
- API calls go to: `https://portfolio-draft-3.preview.emergentagent.com/api`
