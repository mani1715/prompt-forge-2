...
- **Page URL**: `https://bug-solver-14.preview.emergentagent.com/client/dashboard` (HTTPS)
...
### Production (HTTPS)
- Page loads at: `https://bug-solver-14.preview.emergentagent.com`
- API calls go to: `https://bug-solver-14.preview.emergentagent.com/api`
