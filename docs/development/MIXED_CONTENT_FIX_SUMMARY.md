...
# CORS Configuration
CORS_ORIGINS=http://localhost:3000,https://portfolio-project-1.preview.emergentagent.com
...
- `https://portfolio-project-1.preview.emergentagent.com` - for production
