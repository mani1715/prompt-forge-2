...
1. **Frontend page loads** over HTTPS: `https://web-codebase-3.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://web-codebase-3.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://web-codebase-3.preview.emergentagent.com/client/dashboard`
