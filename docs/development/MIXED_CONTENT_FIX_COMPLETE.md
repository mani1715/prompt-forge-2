...
- Frontend was loaded over **HTTPS** (https://portfolio-project-1.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://portfolio-project-1.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://portfolio-project-1.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://portfolio-project-1.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://portfolio-project-1.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://portfolio-project-1.preview.emergentagent.com
- Admin Panel: https://portfolio-project-1.preview.emergentagent.com/admin/login
