...
- Frontend was loaded over **HTTPS** (https://bug-solver-14.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://bug-solver-14.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://bug-solver-14.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://bug-solver-14.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://bug-solver-14.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://bug-solver-14.preview.emergentagent.com
- Admin Panel: https://bug-solver-14.preview.emergentagent.com/admin/login
