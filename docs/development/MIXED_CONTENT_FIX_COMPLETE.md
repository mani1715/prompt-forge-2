...
- Frontend was loaded over **HTTPS** (https://code-forge-43.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://code-forge-43.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://code-forge-43.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://code-forge-43.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://code-forge-43.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://code-forge-43.preview.emergentagent.com
- Admin Panel: https://code-forge-43.preview.emergentagent.com/admin/login
