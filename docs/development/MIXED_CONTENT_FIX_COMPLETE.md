...
- Frontend was loaded over **HTTPS** (https://prompt-forge-116.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://prompt-forge-116.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://prompt-forge-116.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://prompt-forge-116.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://prompt-forge-116.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://prompt-forge-116.preview.emergentagent.com
- Admin Panel: https://prompt-forge-116.preview.emergentagent.com/admin/login
