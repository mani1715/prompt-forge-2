...
```
Mixed Content: The page at 'https://bug-solver-14.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://bug-solver-14.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://bug-solver-14.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://bug-solver-14.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://bug-solver-14.preview.emergentagent.com/api/client/projects \
