...
✅ **Production (HTTPS)**: API calls use `https://code-forge-43.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://code-forge-43.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://code-forge-43.preview.emergentagent.com/api/client/projects \
