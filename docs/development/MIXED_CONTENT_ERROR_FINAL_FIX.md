...
```
Mixed Content: The page at 'https://prompt-forge-116.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://prompt-forge-116.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://prompt-forge-116.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://prompt-forge-116.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://prompt-forge-116.preview.emergentagent.com/api/client/projects \
