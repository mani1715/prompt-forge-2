...
```
Mixed Content: The page at 'https://portfolio-project-1.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://portfolio-project-1.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://portfolio-project-1.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://portfolio-project-1.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://portfolio-project-1.preview.emergentagent.com/api/client/projects \
