...
```
Mixed Content: The page at 'https://web-codebase-3.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://web-codebase-3.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://web-codebase-3.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://web-codebase-3.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://web-codebase-3.preview.emergentagent.com/api/client/projects \
