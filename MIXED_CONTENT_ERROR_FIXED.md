...
1. **Frontend page loads** over HTTPS: `https://webdev-build.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://webdev-build.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://webdev-build.preview.emergentagent.com/client/dashboard`
