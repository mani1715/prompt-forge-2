...
### The Specific Error:
```
Mixed Content: The page at 'https://code-craft-57.preview.emergentagent.com/client/dashboard' 
...
1. **Frontend page loads** over HTTPS: `https://code-craft-57.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://code-craft-57.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://code-craft-57.preview.emergentagent.com/client/dashboard`
