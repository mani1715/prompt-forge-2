...
1. **Frontend page loads** over HTTPS: `https://secure-network-10.preview.emergentagent.com/client/dashboard`
2. **API request is made** with relative URL: `/api/client/projects/`
3. **Browser automatically constructs** the full URL using the current protocol: `https://secure-network-10.preview.emergentagent.com/api/client/projects/`
...
Visit: `https://secure-network-10.preview.emergentagent.com/client/dashboard`
