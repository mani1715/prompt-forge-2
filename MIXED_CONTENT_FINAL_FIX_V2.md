...
const api = axios.create({
  baseURL: getBaseURL(),  // e.g., "https://webdev-build.preview.emergentagent.com/api"
...
// Returns: "https://webdev-build.preview.emergentagent.com/api" on HTTPS pages
...
1. **Page Loads**: `https://webdev-build.preview.emergentagent.com/client/dashboard`
2. **getBaseURL() Executes**:
   ...
   - Constructs: `'https://webdev-build.preview.emergentagent.com/api'`
3. **API Call Made**: `api.get('/client/projects')`
4. **Full URL**: `https://webdev-build.preview.emergentagent.com/api/client/projects`
...
[API Config] Constructed baseURL: https://webdev-build.preview.emergentagent.com/api
[API Request] GET https://webdev-build.preview.emergentagent.com/api/client/projects
```
...
- Go to: `https://webdev-build.preview.emergentagent.com/client/dashboard`
- Login if needed
