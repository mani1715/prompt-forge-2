...
- Frontend was loaded over **HTTPS** (https://webdev-build.preview.emergentagent.com)
...
```
Mixed Content: The page at 'https://webdev-build.preview.emergentagent.com/admin/clients' 
...
1. **When you access the site via HTTPS:**
   - Frontend detects: `window.location.origin` = "https://webdev-build.preview.emergentagent.com"
   - Backend URL configured as: `/api`
   - Final API URL: "https://webdev-build.preview.emergentagent.com/api" ✅
...
**After (Success):**
```
✅ [API Request] Using origin-based URL: https://webdev-build.preview.emergentagent.com/api
✅ Request successful
```
...
- Frontend: https://webdev-build.preview.emergentagent.com
- Admin Panel: https://webdev-build.preview.emergentagent.com/admin/login
