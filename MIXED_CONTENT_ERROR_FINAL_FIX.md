...
```
Mixed Content: The page at 'https://webdev-build.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://webdev-build.preview.emergentagent.com/api/...`
...
```
[API] Constructed URL: https://webdev-build.preview.emergentagent.com/api/client/projects
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://webdev-build.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://webdev-build.preview.emergentagent.com/api/client/projects \
