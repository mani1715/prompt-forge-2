...
```
Mixed Content: The page at 'https://secure-network-10.preview.emergentagent.com/client/dashboard' 
...
✅ **Production (HTTPS)**: API calls use `https://secure-network-10.preview.emergentagent.com/api/...`
...
2. **Request Interceptor runs**:
   ...
   // Constructs full URL
   fullUrl = 'https://secure-network-10.preview.emergentagent.com/api/client/projects'
   ```
...
2. **Test API Directly**:
   ```bash
   curl -X GET https://secure-network-10.preview.emergentagent.com/api/client/projects \
