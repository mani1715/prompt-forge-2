...
- **Page loaded over**: `https://api-secure-update.preview.emergentagent.com/client/dashboard`
...
DB_NAME=mspn_dev_db
CORS_ORIGINS=https://code-medic-35.preview.emergentagent.com,http://localhost:3000
